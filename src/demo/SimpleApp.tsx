            ...
            <Stack spacing={3}>
              ...
              <FormControl>
                ...
                <RadioGroup
                  ...
                  onChange={(e) =>
                    updateConfig("digitCount", parseInt(e.target.value))
                  }
                >
                  <FormControlLabel
                    value={4}
                ...
                <FormControlLabel
                  control={
                    <Switch
                      ...
                      onChange={(e) =>
                        updateConfig("showResend", e.target.checked)
                      }
                    />
                  }
              ...
              <Box>
                <FormControlLabel
                  control={
                    <Switch
                      checked={demoConfig.showExpirationTimer}
                      onChange={(e) =>
                        updateConfig("showExpirationTimer", e.target.checked)
                      }
                    />
                  }
              ...
              <TextField
                ...
                onChange={(e) =>
                  updateConfig("instructionText", e.target.value)
                }
                multiline
                rows={2}
              />
            ...
            <Box sx={{ maxHeight: 400, overflow: "auto" }}>
              {verificationResults.length === 0 ? (
                <Typography variant="body2" color="text.secondary">
                  No verification attempts yet. Try entering an OTP above!
                </Typography>
              ) : (
                <Stack spacing={1}>
                  {verificationResults.map((result, index) => {
                    ...
                    return (
                      <Box key={`${result.timestamp}-${index}`}>
                        <Chip
          ...
          <Grid item xs={12} md={6}>
            ...
            <Stack spacing={1}>
              <Box>
                ...
                <Typography variant="body2">Number of OTP digits</Typography>
              </Box>
              <Box>
                <Typography variant="subtitle2">
                  showResend (default: true)
                </Typography>
                <Typography variant="body2">Show/hide resend button</Typography>
              </Box>
              <Box>
                <Typography variant="subtitle2">
              ...
              <Box>
                <Typography variant="subtitle2">instructionText</Typography>
                <Typography variant="body2">Custom instruction text</Typography>
              </Box>
              <Box>
                <Typography variant="subtitle2">
