...
// Main App component for basic demo
const App: React.FC = () => {
	...
	// Mock verification function for demo purposes
			...
			<Container maxWidth="sm" sx={{ py: 4 }}>
				<Box sx={{ textAlign: 'center', mb: 4 }}>
					...
					<Typography variant="body1" color="text.secondary">
						Try entering the OTP: <strong>123456</strong> (or any
						other code to see error handling)
					</Typography>
				</Box>
